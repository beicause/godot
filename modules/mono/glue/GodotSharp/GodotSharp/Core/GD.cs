...
namespace Godot
{
    ...
    public static partial class GD
    {
        ...
        public static byte[] Compress(ReadOnlySpan<byte> bytes, FileAccess.CompressionMode compressionMode)
        {
            using godot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
        ...
        public static byte[] Decompress(ReadOnlySpan<byte> bytes, long bufferSize, FileAccess.CompressionMode compressionMode)
        {
            using godot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
        ...
        /// <param name="compressionMode">The compression mode, one of <see cref="FileAccess.CompressionMode"/></param>
        /// <returns>The decompressed byte array.</returns>
        public static byte[] DecompressDynamic(ReadOnlySpan<byte> bytes, long maxOutputSize, FileAccess.CompressionMode compressionMode)
        {
            using godot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
