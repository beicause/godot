...
template :=  "disable_3d=yes deprecated=no module_mobile_vr_enabled=no module_openxr_enabled=no module_webrtc_enabled=no module_webxr_enabled=no " + base
...
editor:
    scons platform=linuxbsd target=editor compiledb=yes use_llvm=yes linker=mold \
    deprecated=no \
